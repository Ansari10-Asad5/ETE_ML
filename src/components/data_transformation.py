...
from src.utils import save_pkl_object
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info(f"Transformation of Categorical {categorical_columns} columns")
            logging.info(f"Transformation of Numerical {numerical_columns} columns")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('Train and Test data got read')
